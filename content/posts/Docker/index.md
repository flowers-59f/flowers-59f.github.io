...
```
实战：构建Redis主从同步集群
![[Pasted image 20251213140942.png]]
（1）把主从机放在同个网络中
...
```
 ...
 bitnami/redis
```
![[Pasted image 20251213142958.png]]启动一个容器需要关注：
...
![[Pasted image 20251213144113.png]]实战：部署一个开源博客系统（需要一个mysql数据库）
![[Pasted image 20251213144715.png]]
...
![[Pasted image 20251213145558.png]]
compose.yaml
```
name: myblog
services:
...
### Dockerfile
用来制作自己的镜像
![[Pasted image 20251213152626.png]]（1）上传jar包
（2）编写Dockerfile文件
```
vim Dockerfile
```
Dockerfile内容编写
![[Pasted image 20251213153036.png]]
```
...
![[Pasted image 20251213154748.png]]
